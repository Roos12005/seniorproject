...
<div class="row">
    ...
    <form action="#" class="form-horizontal bucket-form" id="preprocess-form" onsubmit="return false;">
        <div class="form-group" style="border: none;">
            <label class="col-sm-3 control-label" for="inputSuccess">Database Name</label>
            <div class="col-lg-4">
...
{!! Html::script('js/bucket-admin/uploader/plupload.full.min.js'); !!}
{!! Html::script('js/bucket-admin/validator.js'); !!}
{!! Html::script('js/bucket-admin/date_helpers.js'); !!}
{!! Html::script('js/bucket-admin/uploader_factory.js'); !!}
